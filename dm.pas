...
type
  Tdm_form = class(TDataModule)
    ...
    t_indicitesta_all: TClientDataSet;
    t_indicitesta_allid_tabella: TIntegerField;
    t_indicitesta_allid_indice: TIntegerField;
    t_indicitesta_allnomekey: TStringField;
    t_indici_all: TClientDataSet;
    t_indici_allid_tabella: TIntegerField;
    t_indici_allid_indice: TIntegerField;
    t_indici_allid_segmento: TIntegerField;
    t_indici_allsegmento: TStringField;
    t_indici_alldirezione: TStringField;
    ...
    t_modelliLayer: TSmallintField;
    t_variabili_appLayer: TSmallintField;
    t_menuLayer: TSmallintField;
    t_serversLayer: TSmallintField;
    t_databasesLayer: TSmallintField;
    t_tabelleLayer: TSmallintField;
    t_campiLayer: TSmallintField;
    t_indicitestaLayer: TSmallintField;
    t_indiciLayer: TSmallintField;
    t_indicitestanuLayer: TSmallintField;
    t_indicinuLayer: TSmallintField;
    t_indicitesta_allLayer: TSmallintField;
    t_indici_allLayer: TSmallintField;
    elenco_prgLayer: TSmallintField;
    t_programmiLayer: TSmallintField;
    t_parametriLayer: TSmallintField;
    tmp_parametriLayer: TSmallintField;
    t_taskLayer: TSmallintField;
    t_usa_fileLayer: TSmallintField;
    t_unionLayer: TSmallintField;
    t_selectLayer: TSmallintField;
    t_aggregLayer: TSmallintField;
    t_formulas_sqlLayer: TSmallintField;
    t_espressioniLayer: TSmallintField;
    tmp_expLayer: TSmallintField;
    t_azioniLayer: TSmallintField;
    t_operazioniLayer: TSmallintField;
    tmp_callparamsLayer: TSmallintField;
    t_ope_x_copiaLayer: TSmallintField;
    t_formLayer: TSmallintField;
    t_controlliformLayer: TSmallintField;
    t_proprieta_controlliLayer: TSmallintField;
    t_value_listLayer: TSmallintField;
    tmp_postabLayer: TSmallintField;
    t_reportLayer: TSmallintField;
    t_printdefLayer: TSmallintField;
    t_reportfieldLayer: TSmallintField;
    t_input_outputLayer: TSmallintField;
