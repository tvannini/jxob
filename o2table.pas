...
type
  ...
  //  property Azione: string Read fazione Write sazione;
    ...
    property CssFooter: string Read fcss_footer Write scss_footer;
...
procedure To2table.scss_footer(const Value: string);
begin
  fcss_footer := Value;
end;
...
procedure To2table.sexpand(const Value: TCtrlExpand);
begin
  fexpand := Value;
end;
